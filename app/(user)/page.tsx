      ...
      <main className="bg-brand-background">
          ...
          <div className="joro-v3-want rounded-[22px] border border-brand-primary/20 p-3.5 shadow-card sm:p-4">
            <div className="relative z-10 flex flex-col gap-4 lg:flex-row lg:items-center">
              ...
              <div className="flex min-w-0 flex-1 items-center gap-3">
                ...
                <div>
                  <p className="text-[11px] font-black uppercase tracking-[0.1em] text-brand-link">
                    Product nahi mila?
                  </p>
        ...
        <section className="mx-auto max-w-7xl px-4 py-5 sm:px-6">
          <div className="mb-3.5 flex items-end justify-between gap-3">
            ...
            <Link
              href="/products"
              className="inline-flex h-9 items-center gap-1 rounded-lg bg-white px-3 text-[11px] font-bold text-brand-link shadow-xs transition hover:bg-brand-soft"
            >
              View All
          ...
          {categories.length > 0 ? (
            ...
            <div className="rounded-[18px] border border-black/[0.05] bg-white p-7 text-center text-[13px] font-medium text-black/45 shadow-xs">
          ...
          <div className="grid items-start gap-3 xl:grid-cols-[minmax(0,1fr)_285px_210px]">
            ...
            <div className="rounded-[22px] border border-black/[0.055] bg-white p-4 shadow-panel">
              ...
              <div className="mb-3.5 flex items-center justify-between gap-3">
                ...
                <Link
                  href="/products"
                  className="inline-flex h-9 shrink-0 items-center gap-1 rounded-lg bg-brand-background px-3 text-[11px] font-bold text-brand-link transition hover:bg-brand-soft"
                >
                  View All
          ...
          <div className="relative overflow-hidden rounded-[22px] bg-[#123D27] px-5 py-6 text-white shadow-panel sm:px-7">
            ...
            <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div>
                ...
                <p className="mt-1.5 max-w-xl text-[13px] font-medium leading-5 text-white/65">
