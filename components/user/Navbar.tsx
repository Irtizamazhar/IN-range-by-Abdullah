        ...
        <header className="sticky top-8 z-40 border-b border-black/[0.06] bg-white shadow-sm">
          <div className="mx-auto flex min-h-[64px] max-w-7xl items-center justify-between px-4 sm:px-6">
            ...
            <div className="flex items-center gap-3">
              <span className="text-[11px] font-black uppercase tracking-[0.13em] text-black/45">
                Secure Checkout
              </span>
      ...
      <header className="sticky top-8 z-40 w-full bg-white shadow-[0_5px_22px_rgba(17,17,17,0.055)]">
          ...
          <div className="mx-auto max-w-7xl px-4 py-2.5 sm:px-6">
            <div className="flex flex-wrap items-center gap-3 lg:flex-nowrap lg:gap-4">
              ...
              <div className="order-2 shrink-0">
                ...
                <p className="mt-0.5 hidden text-[9px] font-bold uppercase tracking-[0.075em] text-black/45 xl:block">
              ...
              >
                ...
                >
                  <div className="flex h-[44px] overflow-hidden rounded-xl border border-black/[0.09] bg-white shadow-[0_3px_14px_rgba(17,17,17,0.045)] transition duration-200 focus-within:border-brand-primary focus-within:ring-2 focus-within:ring-brand-primary/20">
                    <input
                      ...
                      autoComplete="off"
                      className="min-w-0 flex-1 border-0 bg-transparent px-4 text-[13px] font-medium text-brand-dark outline-none placeholder:text-black/40 sm:text-[14px]"
                    />
                ...
                searchQuery.trim()
                  ...
                  <div className="animate-search-suggest-in absolute left-0 right-0 top-[calc(100%+7px)] max-h-[390px] overflow-y-auto rounded-2xl border border-black/[0.08] bg-white p-1.5 text-brand-dark shadow-[0_20px_55px_rgba(0,0,0,0.15)]">
                    {loading ? (
                      <div className="px-4 py-4 text-[12px] font-semibold text-black/45">
                        Searching…
                      </div>
                    ) : null}
              ...
              <div className="order-3 ml-auto flex shrink-0 items-center gap-0.5 lg:order-4 lg:ml-0">
                ...
                >
                  ...
                  <span className="hidden text-[11px] font-black xl:inline">
                    Wants
                  </span>
                ...
                {!session ? (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="hidden max-w-[82px] truncate text-[11px] font-black xl:inline">
                        {session.user
                          ?.name ||
                          "Account"}
                      </span>
                ...
                >
                  ...
                  {totalQty > 0 ? (
                    <span className="absolute right-0 top-0 flex h-[18px] min-w-[18px] items-center justify-center rounded-full bg-brand-primary px-1 text-[9px] font-black text-brand-dark ring-2 ring-white">
                      {totalQty > 99
                        ? "99+"
                        : totalQty}
                    </span>
                ...
                <Link
                  ...
                  className="ml-1 hidden h-10 items-center justify-center rounded-xl bg-brand-primary px-4 text-[11px] font-black text-brand-dark shadow-[0_6px_18px_rgba(183,227,58,0.18)] transition duration-200 hover:-translate-y-0.5 hover:bg-brand-hover md:flex"
                >
                  Seller Bano
                </Link>
              </div>
        ...
        <div className="border-b border-black/[0.055] bg-[#fafbf7]">
          <div className="mx-auto flex max-w-7xl items-center px-4 sm:px-6">
              ...
              {navCategories.map(
                (category) => (
                  <Link
                    ...
                    className="shrink-0 rounded-lg px-3 py-2 text-[11px] font-bold text-black/60 transition hover:bg-brand-soft hover:text-brand-link"
                  >
                    {category}
                  </Link>
                )
            ...
            <Link
              href="/wants"
              className="ml-2 hidden shrink-0 items-center rounded-lg bg-brand-soft px-3 py-1.5 text-[11px] font-black text-brand-link transition hover:bg-brand-primary hover:text-brand-dark lg:inline-flex"
            >
              Trending Wants
            </Link>
          </div>
      ...
      {mobileOpen ? (
        <div className="fixed inset-0 z-[90] bg-white text-brand-dark lg:hidden">
          ...
          <div className="h-[calc(100vh-78px)] overflow-y-auto p-5">
            <p className="mb-3 text-[11px] font-black uppercase tracking-[0.15em] text-brand-link">
              JORO Marketplace
            </p>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <span className="rounded-full bg-brand-dark px-2 py-1 text-[9px] font-black uppercase tracking-wider text-brand-primary">
                  Hot
                </span>
              </Link>
            ...
            <p className="mb-3 text-[11px] font-black uppercase tracking-[0.15em] text-black/40">
              Categories
            </p>
            ...
            <div className="space-y-1">
              <Link
                ...
                className="block rounded-xl px-3 py-3 text-[13px] font-bold text-black/60 transition hover:bg-brand-background"
              >
                Track Order
              </Link>
            ...
            {!session ? (
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className="rounded-xl border border-black/[0.1] px-4 py-3 text-[13px] font-black text-brand-dark"
                >
                  Login
                </button>
                ...
                <button
                  ...
                  className="rounded-xl bg-brand-primary px-4 py-3 text-[13px] font-black text-brand-dark"
                >
                  Sign Up
                </button>
              </div>
              ...
              <div className="space-y-2">
                ...
                "admin" ? (
                  <button
                    ...
                    className="w-full rounded-xl bg-brand-background px-4 py-3 text-left text-[13px] font-black text-brand-dark"
                  >
                    My Profile
                  </button>
                ) : null}
                ...
                <button
                  ...
                  className="w-full rounded-xl px-4 py-3 text-left text-[13px] font-black text-red-600"
                >
                  Logout
                </button>
              </div>
